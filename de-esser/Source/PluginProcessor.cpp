...
//==============================================================================
const juce::String DeesserAudioProcessor::getName() const
{
...
double DeesserAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int DeesserAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int DeesserAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void DeesserAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
//==============================================================================
bool DeesserAudioProcessor::hasEditor() const
{
